...
public class _30_Substring_with_Concatenation_of_All_Words {
	...
	public static List<Integer> findSubstring(String s, String[] words) {
        ...
        /*Get the numbers of each distinct word, and the map to their coressponding index*/
        ...
        /*use a sliding windows to find each solution*/
        for(int i = 0; i < lenWord; i ++) {
            int left = i, right = i, numNotCoveredWords = numDistinctWords;
            /*traverse util all words have been covered*/
            while(right < last) {
                ...
                /*There may be some redundent words or unideal interval, so try to narrow it*/
                while(left < right && numNotCoveredWords == 0) {
                    if(exists[left] != -1) {
                        /*if we get it non fully covered after delete this word, we may run into a solution*/
